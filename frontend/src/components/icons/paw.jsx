export const CatPaw = ({ size = 24, isUploading = false }) => {
    // Геометрия лапки
    const pawPath = "M9 10a5 5 0 0 1 5 5v3.5a3.5 3.5 0 0 1-6.84 1.045Q6.52 17.48 4.46 16.84A3.5 3.5 0 0 1 5.5 10Z";
    // Геометрия ядра (круг, описанный как путь)
    const circlePath = "M12 9a4 4 0 0 1 0 8 4 4 0 0 1 0-8v4a0 0 0 0 1 0 0Q12 13 12 13A0 0 0 0 1 12 9Z";
